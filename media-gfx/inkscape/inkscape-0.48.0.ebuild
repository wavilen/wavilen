...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/inkscape/inkscape-0.48.0.ebuild,v 1.7 2010/11/15 15:11:16 jer Exp $
...
IUSE="dia gnome gs inkjar lcms nls spell wmf geom"
...
src_prepare() {
	...
	use geom && epatch "${FILESDIR}"/${P}-geom.patch
	eautoreconf
}
