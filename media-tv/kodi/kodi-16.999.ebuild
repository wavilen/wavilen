...
src_unpack() {
	[[ ${PV} == *"999" ]] && git-r3_src_unpack || default
}
...
src_prepare() {
	...
	[[ ${PV} == *"999" ]] && emake -f codegenerator.mk
...
src_configure() {
	...
	[[ ${PV} != *"999" ]] && export ac_cv_path_JAVA_EXE=$(which $(usex java java true))
